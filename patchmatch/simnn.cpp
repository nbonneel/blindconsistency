...
void getpixel_bilin(PATCHBITMAP *bimg, int bx, int by, int &r, int &g, int &b) {
...
void check_offset(Params *p, PATCHBITMAP *b, int x, int y, int xp, int yp) {
  //int h = p->patch_w/2;
...
PATCHBITMAP *sim_init_dist_n(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, PATCHBITMAP *ann, PATCHBITMAP *ann_sim) {
  init_xform_tables();
...
template<int PATCH_W>
void sim_nn_n(Params *p, PATCHBITMAP *a, PATCHBITMAP *b,
...
PATCHBITMAP *sim_vote_n(Params *p, PATCHBITMAP *b,
                 PATCHBITMAP *ann, PATCHBITMAP *ann_sim, PATCHBITMAP *bnn, PATCHBITMAP *bnn_sim,
