...
void vec_attempt_n(ACCUM &err, int &xbest, int &ybest, T *apatch, VECBITMAP<T> *b, int bx, int by, PATCHBITMAP *bmask, RegionMasks *region_masks, int src_mask, Params *p) {
...
void XCvec_attempt_n(ACCUM &err, int &xbest, int &ybest, T *adata[PATCH_W][PATCH_W], VECBITMAP<T> *b, int bx, int by, PATCHBITMAP *bmask, RegionMasks *region_masks, int src_mask, Params *p) {
  if ((bx != xbest || by != ybest) &&
