...
/* Code for 3-channel input image. Warning: weight PATCHBITMAPs always encode 32-bit floats, not ints. */
...
PATCHBITMAP *init_nn(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, PATCHBITMAP *bmask=NULL, RegionMasks *region_masks=NULL, RegionMasks *amask=NULL, int trim_patch=1, PATCHBITMAP *ann_window=NULL, PATCHBITMAP *awinsize=NULL);
PATCHBITMAP *init_dist(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, PATCHBITMAP *ann, PATCHBITMAP *bmask=NULL, RegionMasks *region_masks=NULL, RegionMasks *amask=NULL);
...
public:
  PATCHBITMAP *bmp;
  Box box[256];
  RegionMasks(Params *p, PATCHBITMAP *region_masks, int full=0, PATCHBITMAP *bmask=NULL);
};
...
int window_constraint(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, int ax, int ay, int bx, int by, PATCHBITMAP *ann_window=NULL, PATCHBITMAP *awinsize=NULL);

Box get_abox(Params *p, PATCHBITMAP *a, RegionMasks *amask, int trim_patch=1);

PATCHBITMAP *copy_image(PATCHBITMAP *a);

PATCHBITMAP *vote(Params *p, PATCHBITMAP *b,
             PATCHBITMAP *ann, PATCHBITMAP *bnn=NULL,
...
int patch_dist(Params *p, PATCHBITMAP *a, int ax, int ay,
               PATCHBITMAP *b, int bx, int by, int maxval=INT_MAX, RegionMasks *region_masks=NULL);
...
void check_dists(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, PATCHBITMAP *ann, PATCHBITMAP *annd, int max_dist=3, RegionMasks *amask=NULL);
void check_nn(Params *p, PATCHBITMAP *ann, PATCHBITMAP *b, PATCHBITMAP *bmask=NULL, RegionMasks *amask=NULL, RegionMasks *region_masks=NULL);

void getnn(PATCHBITMAP *ann, int x, int y, int &xp, int &yp);

void minnn(Params *p, PATCHBITMAP *a, PATCHBITMAP *b, PATCHBITMAP *ann, PATCHBITMAP *annd, PATCHBITMAP *ann_prev, PATCHBITMAP *bmask, int level, int em_iter, RecomposeParams *rp=NULL, RegionMasks *region_masks=NULL, RegionMasks *amask=NULL, int ntiles=-1);
