...
int sim_fast_patch_dist(int *adata, PATCHBITMAP *b, XFORM bpos, int maxval) {
...
void sim_attempt_n(int &err, int &xbest, int &ybest, int &sbest, int &tbest, int *adata, PATCHBITMAP *b, XFORM bpos, int bx, int by, int bs, int bt, Params *p) {
  //int h = PATCH_W/2;
...
template<int TPATCH_W, int DO_BRANCH>
int sim_patch_dist_ab(Params *p, PATCHBITMAP *a, int ax, int ay, PATCHBITMAP *b, int bx, int by, int bs, int bt, int maxval) {
